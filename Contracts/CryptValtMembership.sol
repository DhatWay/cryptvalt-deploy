...
contract CryptValtMembership {
    ...
    function transferFrom(address from, address to, uint256 tokenId) public {
        ...
        // Handle revenue on transfer — pay the SELLER what they've
        // already earned on THIS token directly (not via the shared
        // revenueClaimed counter, since this token leaves `from`'s
        // token list right after, which already excludes it from the
        // seller's future pendingRevenue() calculations).
